...
module Float64x2 = struct
  ...
  external cvt_int32x4 : t -> int32x4
    = "caml_vec128_unreachable" "caml_neon_cvt_float64x2_int32x4"
    [@@noalloc] [@@unboxed] [@@builtin]

  external cvt_float32x4 : t -> float32x4
    = "caml_vec128_unreachable" "caml_neon_cvt_float64x2_float32x4"
    [@@noalloc] [@@unboxed] [@@builtin]
...
module Int32x4 = struct
  ...
  external cvt_f64 : t -> float64x2
    = "caml_vec128_unreachable" "caml_neon_cvt_int32x4_float64x2"
    [@@noalloc] [@@unboxed] [@@builtin]

  external cvt_f32 : t -> float32x4
    = "caml_vec128_unreachable" "caml_neon_cvt_int32x4_float32x4"
    [@@noalloc] [@@unboxed] [@@builtin]
  ...
  external cvtsx_i64 : t -> int64x2
    = "caml_vec128_unreachable" "caml_neon_cvtsx_int32x4_int64x2"
    [@@noalloc] [@@unboxed] [@@builtin]

  external cvtzx_i64 : t -> int64x2
    = "caml_vec128_unreachable" "caml_neon_cvtzx_int32x4_int64x2"
    [@@noalloc] [@@unboxed] [@@builtin]
