...
BUILTIN(_caml_neon_cvt_float64x2_to_int64x2)
BUILTIN(_caml_neon_cvt_int16x8_to_int8x16_saturating)
BUILTIN(_caml_neon_cvt_int16x8_to_int8x16_saturating_unsigned)
BUILTIN(_caml_neon_cvt_int32x4_to_int16x8_saturating)
BUILTIN(_caml_neon_cvt_int32x4_to_int16x8_saturating_unsigned)
BUILTIN(_caml_neon_cvt_int64x2_to_float64x2)
BUILTIN(_caml_neon_cvtsx_int32x2_to_int64x2)
BUILTIN(_caml_neon_cvtzx_int32x2_to_int64x2)
BUILTIN(_caml_neon_float64x2_cmeq)
BUILTIN(_caml_neon_float64x2_cmge)
BUILTIN(_caml_neon_float64x2_cmgt)
BUILTIN(_caml_neon_float64x2_cmle)
BUILTIN(_caml_neon_float64x2_cmlt)
BUILTIN(_caml_neon_float64x2_round_near)
BUILTIN(_caml_neon_int16x8_neg)
BUILTIN(_caml_neon_int16x8_sshl)
BUILTIN(_caml_neon_int16x8_ushl)
BUILTIN(_caml_neon_int32x4_dup)
BUILTIN(_caml_neon_int32x4_dup_lane)
BUILTIN(_caml_neon_int32x4_sshl)
BUILTIN(_caml_neon_int32x4_ushl)
BUILTIN(_caml_neon_int64x2_bitwise_and)
BUILTIN(_caml_neon_int64x2_bitwise_not)
BUILTIN(_caml_neon_int64x2_bitwise_or)
BUILTIN(_caml_neon_int64x2_bitwise_xor)
BUILTIN(_caml_neon_int64x2_cmpeqz)
BUILTIN(_caml_neon_int64x2_cmpgez)
BUILTIN(_caml_neon_int64x2_cmpgtz)
BUILTIN(_caml_neon_int64x2_cmplez)
BUILTIN(_caml_neon_int64x2_cmpltz)
BUILTIN(_caml_neon_int64x2_dup)
BUILTIN(_caml_neon_int64x2_dup_lane)
BUILTIN(_caml_neon_int64x2_neg)
BUILTIN(_caml_neon_int64x2_sshl)
BUILTIN(_caml_neon_int64x2_ushl)
