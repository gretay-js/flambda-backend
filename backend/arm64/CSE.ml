  ...
  | Specific spec ->
    let op_class : Cfg_cse_target_intf.op_class =
      ...
      | Illvm_intrinsic intr ->
        Misc.fatal_errorf
          "CSE: Unexpected llvm_intrinsic %s: not using LLVM backend" intr
    in
    Class op_class
  | Move | Spill | Reload | Floatop _ | Csel _ | Reinterpret_cast _
  | Static_cast _ | Const_int _ | Const_float32 _ | Const_float _
  | Const_symbol _ | Const_vec128 _ | Const_vec256 _ | Const_vec512 _
  | Stackoffset _ | Load _ | Store _ | Alloc _ | Intop _ | Int128op _
  | Intop_imm _ | Intop_atomic _ | Name_for_debugger _ | Probe_is_enabled _
...
let is_cheap_operation (op : Operation.t) :
  ...
  | Specific _ | Move | Spill | Reload | Floatop _ | Csel _ | Reinterpret_cast _
  | Static_cast _ | Const_float32 _ | Const_float _ | Const_symbol _
  | Const_vec128 _ | Const_vec256 _ | Const_vec512 _ | Stackoffset _ | Load _
  | Store _ | Alloc _ | Intop _ | Int128op _ | Intop_imm _ | Intop_atomic _
  | Name_for_debugger _ | Probe_is_enabled _ | Opaque | Pause | Begin_region
  | End_region | Poll | Dls_get | Tls_get ->
    Cheap false
